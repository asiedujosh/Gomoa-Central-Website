...
<html lang="en">
    ...
    <meta name="description" content="central district, district assembly, ghana assembly">
  ...
  <body>
    ...
    <p class = "text-center">You have one more try</p>
  </div>
</div>
 <div class = "row">
<div class = "col-md-12">
<button type = "submit" class = "btn btn-success" name = "logout" style ="margin-left: 45%;">Sign In</button>
</div>
</div>
</form>
</div>