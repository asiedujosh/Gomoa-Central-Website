...
if(isset($_GET['edit'])){
  $deptNo = $_GET['edit'];
    ...
    $sql = "SELECT * FROM profile WHERE deptNo = $deptNo";
...
$sql = "SELECT * FROM caption WHERE deptNo = $deptNo";
    $db = mysqli_query($conn,$sql);
...
$sql = "SELECT * FROM images WHERE deptNo = $deptNo";
    $db = mysqli_query($conn,$sql);
     ...
     <div class = "container">
      ...
      <div class = "row">
       <div class="col-lg-3 col-md-4 col-xs-6">
        ...
        <div class = "row">
          <div class = "col-md-4">
      <input type = "hidden" name = "foto1" value = "<?php echo $image; ?>"/>
      <br/>
